      ...
      <div class="wrapper">
            ...
            >
              ...
              <ul class="dl-menu">
                ...
                <li>
                  ...
                  <ul class="dl-submenu">
                    <li>
                      <a href="02_listings-list.html">Listing 1</a>
                    </li>
                    <li>
                      <a href="02_listings-grid.html">Listing 2</a>
                    </li>
                  </ul>
                </li>
                <li>
                ...
                <li>
                  <a href={NAVIGATION_CONSTANTS.LOGIN_PATH}>Login/SignUp</a>
                </li>
              </ul>
            </div>
        ...
        <main class="main">
              ...
              <div class="row">
                ...
                >
                  <div>
                    ...
                    <h1
                      class="first__screen-title"
                      style={{ fontSize: "40px" }}
                    >
                      {" "}
                      Connect with Verified Lawyers Instantly <br /> Get Legal
                      Help When You Need It
                    </h1>
                    <p
                      class="first__screen-description"
                      style={{ fontSize: "30px" }}
                    >
                      Chat with experienced lawyers in real-time. First 5
                      minutes free, then pay per minute for expert legal advice.
                    </p>
                    <div class="first__screen-form" style={{ width: "100%" }}>
                      <form action="#">
                        <div class="input-group">
                          ...
                          <button
                            class="btn  dropdown-toggle btn-1"
                            type="button"
                          ...
                          <button
                            class="btn  dropdown-toggle btn-2"
                            type="button"
                            data-bs-toggle="dropdown"
                            aria-expanded="false"
                          >
                          ...
                          <button
                            class="btn  dropdown-toggle btn-3"
                            type="button"
                            data-bs-toggle="dropdown"
                            aria-expanded="false"
                          >
                          ...
                          <button
                            class="btn  dropdown-toggle btn-4"
                            type="button"
                            data-bs-toggle="dropdown"
                            aria-expanded="false"
                          >
                          ...
                          <button
                            type="submit"
                            class="first-bg-color btn-hover-animate"
                          >
                            {" "}
                            search
                    ...
                    <div class="first__screen-recent"></div>
                  </div>
                </div>
              </div>
            </section>
          ...
          <section class="hand__picked">
            <div class="container">
              <h3 class="hand__picked-subtitle text-center first-color">
                {" "}
                Explore all offer for business
              </h3>
              <h2 class="hand__picked-title text-center">
                {" "}
                Legal Specializations or Find Lawyers by Practice Area{" "}
              </h2>
              <div class="row gx-0">
                <div class="col">
              ...
              <h3 class="hand__picked-featured text-center">
                {" "}
                We're Featured On ...{" "}
              </h3>
            </div>
            <div class="container__1320">
              <div class=" row justify-content-lg-between justify-content-center align-items-center flex-wrap text-center">
                <div class="mb-12 col-sm-12 col-lg-12 d-flex justify-content-center">
                  <div class="hand__picked-brand">
                    <img
                      src="https://tse3.mm.bing.net/th?id=OIP.EXyMVn2AvTU58ahj_1DGvQHaDj&pid=Api&P=0&h=180"
                      alt="eastin"
                  ...
                  <div class="hand__picked-brand">
                    <img
                      src="https://gttb.com/wp-content/uploads/2024/06/Lawyer-International-Legal-100-2024-GTB-Technologies-Inc.-1.pdf-1.pdf-1.png"
                      alt="eastin"
                      style={{ width: "350px", height: "200px" }}
                    />
                  </div>
                  <div class="hand__picked-brand">
                    <img
                      src="https://www.revechat.com/wp-content/uploads/2022/10/types-of-customer-satisfaction-rating-scale.png"
                      alt="eastin"
                      style={{ width: "350px", height: "200px" }}
                    />
                  </div>
                  <div class="hand__picked-brand">
                    <img
                      src="https://static1.galls.com/photos/styles/qm/zoom/S01-663.jpg"
                      alt="eastin"
                      style={{ width: "350px", height: "200px" }}
                    />
                  </div>
          ...
          <section class="featured__category second-bg-color py-105">
            <div class="container__1320">
              ...
              <h2 class="featured__category-title text-center">
                {" "}
                Featured Categories{" "}
              </h2>
              <div class="row text-center g-5">
                ...
                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                  <div class="featured__category_box featured__category_box_style2">
                    <a href="#">
                      <img
                        src="https://png.pngtree.com/png-vector/20240125/ourmid/pngtree-judge-and-courtroom-png-image_11550438.png"
                        alt="phone-laptops"
                      />
                ...
                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                  <div class="featured__category_box featured__category_box_style2">
                    <a href="#">
                      <img
                        src="http://getdrawings.com/free-icon-bw/commercial-real-estate-icons-22.png"
          ...
          <section class="popular__listing py-105 mb-105">
            <div class="container">
              ...
              <h2 class="popular__listing-title text-center">
                {" "}
              ...
              <div class="listing__products">
                ...
                >
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      type="button"
                      role="tab"
                      data-aria-controls="pills-profile"
                      aria-selected="false"
                    >
                      {" "}
                      Top Rated{" "}
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      data-bs-toggle="pill"
                      data-bs-target="#pills-most-viewed"
                      type="button"
                      role="tab"
                      data-aria-controls="pills-contact"
                      aria-selected="false"
                    >
                      {" "}
                      Most Viewed{" "}
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      data-bs-toggle="pill"
                      data-bs-target="#pills-most-popular"
                      type="button"
                      role="tab"
                      data-aria-controls="pills-contact"
                      aria-selected="false"
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div
                    ...
                    id="pills-all"
                    role="tabpanel"
                    data-aria-labelledby="pills-home-tab"
                  >
                    <div class="row slww">
                      <div class=" col-12 col-xl-4 col-md-6">
                        <div class="listing-card ll-none">
                          <div
                            class="listing-card__box listing-card__box_featured"
                            data-marker="3"
                          >
                            <div class="listing-card__media shine">
                              <a href="02_listings-grid.html">
                                <img
                                  src="https://static2.bigstockphoto.com/5/6/3/large1500/365525101.jpg"
                                  width="360"
                                  height="270"
                                  alt="Fadisy Restaurant"
                                />
                              </a>
                            ...
                            <div class="listing-card__middle">
                              <div class="listing-card__body">
                                ...
                                <div class="data_info">
                                  <i class="fa fa-map-pin"></i>Washington DC,
                                  USA
                                </div>
                                <p class="body-text">
                                  Quis nostrud exercitation ullamco laboris
                                  nisit aliquip ex ea commodo consequat...
                                </p>
                              </div>
                        ...
                        <div class="listing-card ll-none">
                          <div class="listing-card__box" data-marker="1">
                            <div class="listing-card__media shine">
                              <a href="02_listings-grid.html">
                                <img
                                  src="https://www.lawyer.com/img/banner-image.jpg"
                                  width="360"
                                  alt="Fadisy Restaurant"
                                />
                              </a>
                        ...
                        <div class="listing-card ll-none">
                          <div class="listing-card__box">
                            <div class="listing-card__media shine">
                              <a href="02_listings-grid.html">
                                <img
                                  src="https://fthmb.tqn.com/Kcf8EVzEvVsS3hV4l_3KVipw6GE=/4841x3633/filters:fill(auto,1)/Gettywomanlawyer-5955ab903df78cdc296e8f7e.jpg"
                                  width="360"
                                  height="270"
                                  alt="Fadisy Restaurant"
                                />
                        ...
                        <div class="listing-card ll-none">
                          <div class="listing-card__box">
                            <div class="listing-card__media shine">
                              <a href="02_listings-grid.html">
                                <img
                                  src="https://img.freepik.com/premium-photo/professional-lawyer-image-generated-ai_644690-13316.jpg"
                                  width="360"
                                  height="270"
                                  alt="Fadisy Restaurant"
                                />
              ...
              <div>
                <div class="row">
                  <div class="col-12 col-lg-6">
                    <h2 class="we__offer-title">
                      {" "}
                      We Offer Wide Range of Listings Promoting Your Business{" "}
                    </h2>
                  </div>
                  <div class="col-12 col-lg-6">
                    <div class="col-a-right">
                      <a
                        href="#"
                        class="link__template btn-hover-animate d-flex "
                      >
              ...
              <div class="row we__offer-item">
                <div class="col-12 col-lg-4 p-0 m-0">
                  <div class="we__offer-card d-flex flex-column">
                    <div class="we__offer-card_icon">
                      <i class="icon-search second-color"></i>
                    </div>
                    <h5 class="title">Huge Products Listings</h5>
                    <p class="text">
                      {" "}
                      If you enjoy the thrill of a bargain, you're probably
                      always shopping online, on your phone or in the high
                      street.{" "}
                    </p>
                  </div>
                </div>
                <div class="col-12 col-lg-4 p-0 m-0">
                  <div class="we__offer-card d-flex flex-column">
                    <div class="we__offer-card_icon">
                      <i class="icon-scope second-color"></i>
                    </div>
                    <h5 class="title">Easily Find Services</h5>
                    <p class="text">
                      {" "}
                      Easily Find Services is the best way to find top-rated
                      businesses in your area. Check us out today!{" "}
                    </p>
                  </div>
                </div>
                <div class="col-12 col-lg-4 p-0 m-0">
                  <div class="we__offer-card d-flex flex-column">
                    <div class="we__offer-card_icon">
                      <i class="icon-finder second-color"></i>
                    </div>
                    <h5 class="title">Guaranteed Prices</h5>
                    <p class="text">
                      {" "}
                      No matter what your budget is, we guarantee that you'll
                      find something you love at our store!{" "}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section class="reviews reviews2 py-105">
            <div class="container__1575" style={{ marginTop: "-300px" }}>
              <h3 class="reviews__subtitle text-center first-color">
                {" "}
              ...
              <div class="reviews__slider">
                <div class="item">
                  <div class="item-card">
                    ...
                    <div class="fl-text ">
                      {" "}
                      I love the templines that come with this feeder. The
                      birders in my area love them too. They are easy to
                      assemble and make it easy for me to change the birdseed.{" "}
                    </div>
                    <div class="row g-0">
                      <div class="col-lg-2">
                        <img
                      ...
                      <div class="col-lg-10">
                        <div class="card-body">
                          ...
                          <div class="card-body-review-star">
                            <i
                              class="fa fa-star fa-star-active"
                              aria-hidden="true"
                            ></i>
                            <i
                              class="fa fa-star fa-star-active"
          ...
          <div class="footer-email">
            ...
            <div class="row">
              <div class="col-12 col-lg-6 email-text">
                <h2>
                  {" "}
                  SignUp for Updates, <br /> Get Subscribed Today!{" "}
                </h2>
              </div>
              <div class="col-12 col-lg-6 form-email d-flex align-items-center">
                <form action="#">
                  ...
                  <button
                    type="submit"
                    class="btn-hover-animate first-bg-color"
                  >
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg col-12 column-first">
                  ...
                  <p class="text">
                    {" "}
                    We believe that the best way to make sure our products are
                    the best they can be is to listen to what our customers have
                    to say. That’s why we’re constantly asking for feedback and
                    publishing reviews by customers on our website.
                  </p>
                  <div class="d-flex flex-wrap flex-lg-column justify-content-between">
                    <a class="phone" href="tel:+12020003399">
                      <i class="fa-solid fa-phone-volume"></i> +(1)202 00 3399
                    </a>
